...
public class Test {
    ...
    private void testBasicOperations() {
        ...
        if (heap.findMin().key != 2) {
            throw new AssertionError("Minimum should be 2");
        }
        if (heap.size() != 3) {
            throw new AssertionError("Size should be 3");
        }

        heap.deleteMin();
        if (heap.findMin().key != 4) {
            throw new AssertionError("After deleteMin, minimum should be 4");
        }
        if (heap.size() != 2) {
            throw new AssertionError("After deleteMin, size should be 2");
        }
    ...
    private void testMeld() {
        ...
        heap1.meld(heap2);
        if (heap1.findMin().key != 1) {
            throw new AssertionError("After meld, minimum should be 1");
        }
        if (heap1.size() != originalSize) {
            throw new AssertionError("After meld, size should be sum of original sizes");
        }
    ...
    private void testDecreaseKey() {
        ...
        if (heap.findMin().key != 1) {
            throw new AssertionError("After decreaseKey, minimum should be 1");
        }
        if (heap.findMin() != node1) {
            throw new AssertionError("After decreaseKey, node1 should be minimum");
        }
    ...
    private void testDelete() {
        ...
        heap.delete(node1);
        if (heap.size() != originalSize - 1) {
            throw new AssertionError("After delete, size should decrease by 1");
        }
        if (heap.findMin().key != 3) {
            throw new AssertionError("After delete, minimum should be 3");
        }
    ...
    private void testEdgeCases() {
        ...
        if (heap.findMin() != null) {
            throw new AssertionError("Empty heap should have null minimum");
        }
        if (heap.size() != 0) {
            throw new AssertionError("Empty heap should have size 0");
        }

        FibonacciHeap.HeapNode node = heap.insert(1, "one");
        if (heap.size() != 1) {
            throw new AssertionError("Size should be 1 after single insert");
        }
        heap.delete(node);
        if (heap.size() != 0) {
            throw new AssertionError("Size should be 0 after deleting only node");
        }
        if (heap.findMin() != null) {
            throw new AssertionError("Minimum should be null after deleting only node");
        }
    ...
    private void testStressTest() {
        ...
        if (heap.size() != 1000) {
            throw new AssertionError("Size should be 1000 after insertions");
        }
        if (heap.findMin().key != 1) {
            throw new AssertionError("Minimum should be 1");
        }
        ...
        if (heap.size() != 500) {
            throw new AssertionError("Size should be 500 after deletions");
        }
        if (heap.findMin().key != 1) {
    ...
    private void testRandomMeld() {
        ...
        for (int test = 0; test < 10; test++) {
            ...
            heap1.meld(heap2);
            if (heap1.findMin().key != expectedMin) {
                throw new AssertionError("Incorrect minimum after random meld");
            }
            if (heap1.size() != size1 + size2) {
                throw new AssertionError("Incorrect size after random meld");
            }
        }
    ...
    private void testNumTrees() {
        ...
        if (heap.numTrees() != 10) {
            throw new AssertionError("Initial number of trees should be 10");
        }
        ...
        heap.deleteMin();
        if (heap.numTrees() != 3) {
            throw new AssertionError("Number of trees after delete operations should be 3");
        }
        ...
        heap.meld(heap2);
        if (heap.numTrees() != 6) {
            throw new AssertionError("Number of trees after meld should be 6");
        }
    ...
    private void testSize() {
        ...
        FibonacciHeap heap = new FibonacciHeap();
        if (heap.size() != 0) {
            throw new AssertionError("Initial size should be 0");
        }

        heap.insert(1, "one");
        if (heap.size() != 1) {
            throw new AssertionError("Size should be 1 after insert");
        }

        heap.insert(2, "two");
        if (heap.size() != 2) {
            throw new AssertionError("Size should be 2 after another insert");
        }

        heap.deleteMin();
        if (heap.size() != 1) {
            throw new AssertionError("Size should be 1 after deleteMin");
        }

        heap.deleteMin();
        if (heap.size() != 0) {
            throw new AssertionError("Size should be 0 after another deleteMin");
        }
    ...
    private void testFindMin() {
        ...
        heap.insert(1, "one");
        if (heap.findMin().key != 1) {
            throw new AssertionError("Minimum should be 1 after insert");
        }

        heap.insert(2, "two");
        if (heap.findMin().key != 1) {
            throw new AssertionError("Minimum should be 1 after another insert");
        }

        heap.deleteMin();
        if (heap.findMin().key != 2) {
            throw new AssertionError("Minimum should be 2 after deleteMin");
        }

        heap.insert(0, "zero");
        if (heap.findMin().key != 0) {
            throw new AssertionError("Minimum should be 0 after insert");
        }
    ...
    private void testInsert() {
        ...
        if (heap.findMin() != node) {
            throw new AssertionError("Node should be minimum after insert");
        }
    ...
    private void testDeleteMin() {
        ...
        if (heap.size() != 2) {
            throw new AssertionError("Size should be 2 after deleteMin");
        }

        heap.deleteMin();
        if (heap.findMin().key != 3) {
            throw new AssertionError("Minimum should be 3 after another deleteMin");
        }
        if (heap.size() != 1) {
            throw new AssertionError("Size should be 1 after another deleteMin");
        }

        heap.deleteMin();
        if (heap.findMin() != null) {
            throw new AssertionError("Minimum should be null after last deleteMin");
        }
        if (heap.size() != 0) {
            throw new AssertionError("Size should be 0 after last deleteMin");
        }
        ...
        for (int i = 0; i < 999; i++) {
            heap.insert(rand.nextInt(999), "key" + i);
        }
        for (int i = 0; i < 999; i++) {
            heap.deleteMin();
        }
        if (heap.findMin().key != 1000) {
            throw new AssertionError("Minimum should be 1000 after deleting random nodes");
        }
    ...
    private void test0_BasicOperations() { // test0
        ...
        if (!heap.empty()) {
            throw new AssertionError("Heap should be empty after all deletions");
        }
    ...
    private void test2_DeleteMiddleNodes() { // test2
        ...
        for (int i = 1; i <= 4; i++) {
            if (heap.findMin().getKey() != i) {
                throw new AssertionError("Minimum should be " + i);
            }
            heap.deleteMin();
        }
    ...
    private void test3_EdgeCases() { // test3
        ...
        FibonacciHeap heap = new FibonacciHeap();
        if (heap.findMin() != null) {
            throw new AssertionError("Minimum of empty heap should be null");
        }
        if (!heap.empty()) {
            throw new AssertionError("Heap should be empty initially");
        }

        FibonacciHeap.HeapNode node = heap.insert(1, "key1");
        heap.delete(node);
        if (heap.findMin() != null) {
            throw new AssertionError("Heap should be empty after deleting the only node");
        }
        if (!heap.empty()) {
            throw new AssertionError("Heap should be empty after deleting the only node");
        }
    ...
    private void test5_DecreaseKeyBehavior() { // test5
        ...
        if (heap.findMin().getKey() != 10) {
            throw new AssertionError("Minimum should still be 10");
        }

        heap.decreaseKey(node2, 5);
        if (heap.findMin().getKey() != 5) {
            throw new AssertionError("Minimum should now be 5");
        }
    ...
    private void test8_HeapSizeConsistency() { // test8
        ...
        for (int i = 1; i <= 500; i++) {
            heap.insert(i, "key" + i);
            if (heap.size() != i) {
                throw new AssertionError("Heap size should be " + i);
            }
        }
        ...
        for (int i = 1; i <= 500; i++) {
            heap.deleteMin();
            if (heap.size() != 500 - i) {
                throw new AssertionError("Heap size should be " + (500 - i));
            }
        }
        if (!heap.empty()) {
            throw new AssertionError("Heap should be empty after all deletions");
    ...
    private void test9_EdgeCaseSingleNode() { // test9
        ...
        if (heap.findMin() != node) {
            throw new AssertionError("Minimum should be the only node");
        }
    ...
    private void test10_EdgeCaseEmptyHeap() { // test10
        ...
        if (heap.size() != 0) {
            throw new AssertionError("Size of empty heap should be 0");
        }
    ...
    private void test12() { // test12
        ...
        for (int i = 0; i < 2; i++) {
            if (heap.findMin().getKey() != 1000) {
                throw new AssertionError("Minimum should be 1000");
            }
            heap.deleteMin();
        }
    ...
    private void test13() { // test13
        ...
        if (heap.findMin().getKey() != 5000) {
            throw new AssertionError("Minimum should now be 5000");
        }
        heap.deleteMin();
        if (!heap.empty()) {
            throw new AssertionError("Heap should be empty after all deletions");
    ...
    private void test16() { // test16
        ...
        if (!checkMinHeapProperty(heap)) {
            throw new AssertionError("Min-Heap property violated.");
        }

        // Ensure no cuts or links have occurred yet
        if (heap.totalCuts() - cuts != 0) {
            throw new AssertionError("No cuts should have occurred");
        }
        if (heap.totalLinks() - links != 0) {
            throw new AssertionError("No links should have occurred");
        }
    ...
    private void test17() { // test17
        ...
        if (heap.totalLinks() - links != 1) {
            throw new AssertionError("One link should have occurred");
        }

        // Ensure rank distribution is correct
        if (heap.min.rank != 1 || heap.min.child.rank != 0) {
            throw new AssertionError("Invalid rank distribution.");
        }
    ...
    private void test18() { // test18
        ...
        if (heap.totalLinks() - links != 3) {
            throw new AssertionError("Three links should have occurred");
        }

        // Check rank distribution
        if (heap.min.rank != 2 && heap.min.child.rank != 0 && heap.min.child.next.rank != 1 && heap.min.child.next.child.rank != 0) {
            throw new AssertionError("Invalid rank distribution.");
        }
    ...
    private void test19() { // test19
        ...
        if (heap.totalCuts() - cuts != 1) {
            throw new AssertionError("One cut should have occurred");
        }
        if (heap.totalLinks() - links != 3) {
            throw new AssertionError("Three links should have occurred");
        }
    ...
    private void test22() { // test22
        ...
        if (!noCascading) {
            throw new AssertionError("Cascading cuts detected");
        }

        // Ensure number of trees is as expected
        if (heap.size() != treeSize) {
            throw new AssertionError("Tree size mismatch");
        }
    ...
    private void test26() { // test26
        ...
        for (int i = 0; i < size / 2; i++) {
            if (heap.findMin().getKey() != i + 1) {
                throw new AssertionError("Minimum should match");
            }
            heap.deleteMin();
        }
        ...
        if (heap.totalLinks() - links < size - 100) {
            throw new AssertionError("Links count mismatch");
        }
    ...
    private void testLargeBasicOperations() {
        ...
        if (heap.size() != 10000) {
            throw new AssertionError("Size should be 10000");
        }

        for (int i = 0; i < 5000; i++) {
            heap.deleteMin();
        }
        if (heap.findMin().key != 5001) {
            throw new AssertionError("Minimum should be 5001 after deleting 5000 elements");
        }
        if (heap.size() != 5000) {
            throw new AssertionError("Size should be 5000 after deleting 5000 elements");
        }
    ...
    private void testLargeMeld() {
        ...
        heap1.meld(heap2);
        if (heap1.findMin().key != 1) {
            throw new AssertionError("Minimum should be 1 after meld");
        }
        if (heap1.size() != 10000) {
            throw new AssertionError("Size should be 10000 after meld");
        }
    ...
    private void testExtremeDecreaseKey() {
        ...
        if (heap.findMin().key != 1) {
            throw new AssertionError("Minimum should be 1 after decreaseKey");
        }
        if (heap.findMin() != nodes[0]) {
            throw new AssertionError("Node with key 1 should be the minimum");
        }
    ...
    private void testExtremeDelete() {
        ...
        if (heap.size() != 0) {
            throw new AssertionError("Heap size should be 0 after deleting all elements");
        }
        if (heap.findMin() != null) {
            throw new AssertionError("Minimum should be null after deleting all elements");
        }
    ...
    private void testLargeEdgeCases() {
        ...
        if (heap.findMin().key != 1) {
            throw new AssertionError("Minimum should be 1 after decreasing key to 1");
        }

        heap.delete(node);
        if (heap.size() != 0) {
            throw new AssertionError("Heap size should be 0 after deleting only node");
        }
    ...
    private void testLargeStressTest() {
        ...
        if (heap.size() != 100000) {
            throw new AssertionError("Heap size should be 100000 after insertions");
        }
        if (heap.findMin().key != 0) {
            throw new AssertionError("Minimum should be 0");
        }
        ...
        if (heap.size() != 50000) {
            throw new AssertionError("Heap size should be 50000 after 50000 deletions");
        }
        if (heap.findMin().key != 50000) {
            throw new AssertionError("Minimum should be 50000 after deletions");
        }
